# -*- coding: utf-8 -*-
"""Mid_Project_MultiCrypto_Trading.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16wTGp5h1_0HbAyPMXB3tOA6tE7m6T6cW

## This is the code used for the midterm presentation
...
# %cd /
!git clone https://github.com/AI4Finance-Foundation/FinRL-Meta #ai 저장소
# %cd /FinRL-Meta/
...
#Define the learning algorithm through the data of the entered date

def train(start_date, end_date, ticker_list, data_source, time_interval, 
          technical_indicator_list, drl_lib, env, model_name, if_vix=True,
          **kwargs):

#start_date : data start date, end_date : data end date, ticker_list : data type
#data_source : cryptocurrency exchange name, time_interval : data time interval, 
#technical_indicator_list : chart indicator, #drl_lib : Deep reinforce learning library, 
#model_name : DRL algorithm, if_vix=True,  
...
#Defining test algorithms to validate learning results with test data
...
TEST_START_DATE = '2022-04-18'
TEST_END_DATE = '2022-04-19'

INDICATORS = ['macd', 'rsi', 'cci', 'dx'] #Define technical indicator list 
...
# learning_rate : learning rate of optimizer, batch_size :  the size of batch data for Stochastic Gradient Descent
# gamma : discount factor, seed : random seeds, net_dimension : the dimension of networks
...
plt.plot(agent_returns, label='TradingBot', color = 'red') 
...
plt.grid(which='minor', axis='y')
plt.title('Cryptocurrency Trading ', fontsize=20)
plt.plot(agent_returns, label='TradingBot', color = 'green')
